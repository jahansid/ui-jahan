...
const CardContent = () => {
  return (
    <div className="bg-gray-100 h-screen w-full grid place-content-center font-sans">
      ...
      <div className=" w-96 min-h-[32rem] h-[32rem] flex flex-col gap-3  p-6 bg-white rounded-2xl shadow-[0_1px_1px_rgba(0,0,0,0.05),0_4px_6px_rgba(34,42,53,0.04),0_24px_68px_rgba(47,48,55,0.05),0_2px_3px_rgba(0,0,0,0.04)]">
        ...
        <div className=" flex justify-center items-center">
          <button className=" flex items-center justify-center gap-2 text-[12px] mt-8 px-2 py-1 font-semibold text-neutral-600 border border-gray-200 shadow-[0_1px_1px_rgba(0,0,0,0.05),0_4px_6px_rgba(34,42,53,0.04),0_24px_68px_rgba(47,48,55,0.05),0_2px_3px_rgba(0,0,0,0.04)] rounded-lg">
